				...
				<div class="bg-standard px-7 shadow-lg rounded-t-2xl">
					<div class="flex">
						...
						<div class="flex-1 group">
							...
							>
								<span class="block px-1 pt-1 pb-1">
									<i class="far fa-video text-2xl pt-1 mb-1 block"></i>
									<span class="block text-xs pb-2">Reels</span>
									<span
										class="block w-5 mx-auto h-1 group-hover:bg-indigo-500 rounded-full"
									></span>
								</span>
						...
						<div class="flex-1 group">
							...
							>
								<span class="block px-1 pt-1 pb-1">
									<i class="far fa-heart text-2xl pt-1 mb-1 block"></i>
									<span class="block text-xs pb-2">Activity</span>
									<span
										class="block w-5 mx-auto h-1 group-hover:bg-indigo-500 rounded-full"
									></span>
								</span>
